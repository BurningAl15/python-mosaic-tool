...
def create_mosaic(source_path, target, tile_ratio=1920/800, tile_width=4, enlargement=8, reuse=True, color_mode='RGB', tile_paths=None, shuffle_first=30):
    """Forms an mosaic from an original image using the best
    ...
    # Assets Tiles, and save if needed, returns directories where the small and large pictures are stored
